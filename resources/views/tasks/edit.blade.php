        ...
        <div class="flex items-center justify-between mt-6">
            <div>
                <button type="submit" form="deleteForm"
                    ...
                    <span class="block md:hidden"> Delete</span>
                    <span class="hidden md:block"> Delete task</span></button>
                </button>
            ...
            <div class="flex items-center justify-end gap-x-6">
                ...
                <button type="submit"
                    ...
                    <span class="block md:hidden"> Save</span>
                    <span class="hidden md:block"> Save changes</span></button>
            </div>
        </div>
